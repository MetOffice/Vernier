...
void meto::Formatter::execute_format(std::ofstream& os, meto::hashvec_t hashvec) 
{
...
void meto::Formatter::threads(std::ofstream& os, meto::hashvec_t hashvec)
{
...
void meto::Formatter::drhook(std::ofstream& os, meto::hashvec_t hashvec)
{
