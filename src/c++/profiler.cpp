...
meto::Profiler::StartCalliperValues::StartCalliperValues(
...
size_t meto::Profiler::start(std::string_view region_name)
{

  // Note the time on entry to the profiler call.
  meto::time_point_t calliper_start_time = meto::prof_gettime();
