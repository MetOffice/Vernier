...
[![Coverage](https://img.shields.io/badge/coverage-97.3%25-success?style=flat)](${WORKFLOW_URL})
...
A detailed coverage report can be found [here](https://metoffice.github.io/profiler/coverage/). Additionally, a summary of the unit 
test coverage is automatically provided when creating pull requests.
